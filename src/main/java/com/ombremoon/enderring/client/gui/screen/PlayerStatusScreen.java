...
public class PlayerStatusScreen extends Screen {
    ...
    private void renderBg(GuiGraphics pGuiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        pGuiGraphics.drawString(this.font, Component.literal(getAttribute(EntityAttributeInit.FIRE_DEFENSE.get()) + " / " + getNegation(EntityAttributeInit.FIRE_NEGATE.get())), getProperLocation(EntityAttributeInit.FIRE_DEFENSE.get(), x8 - 1, x7 - 1), y + 124, textColor);
        ...
        pGuiGraphics.drawString(this.font, Component.literal(getAttribute(EntityAttributeInit.HOLY_DEFENSE.get()) + " / " + getNegation(EntityAttributeInit.HOLY_NEGATE.get())), getProperLocation(EntityAttributeInit.HOLY_DEFENSE.get(), x8, x7), y + 147, textColor);
