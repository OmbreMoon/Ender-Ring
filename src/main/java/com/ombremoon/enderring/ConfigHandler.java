...
public class ConfigHandler {
    ...
    public static final ForgeConfigSpec.ConfigValue<Boolean> MUST_MEET_REQUIRE;
    ...
    static {
        ...
        MUST_MEET_REQUIRE = COMMON_BUILDER.define("endderring.config.must_meet_require", true);
