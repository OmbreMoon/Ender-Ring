...
public class ThrowingPot extends ThrowableItemProjectile {
    ...
    protected void onHitEntity(EntityHitResult pResult) {
        ...
        DamageUtil.conditionalHurt(this.getItemRaw(), ((AbstractWeapon)this.getDefaultItem()).getModifiedWeapon(this.getItemRaw()), (LivingEntity) this.getOwner(), (LivingEntity) pResult.getEntity());
    }
