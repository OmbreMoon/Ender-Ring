...
//        Constants.LOG.info(String.valueOf(damage));
    ...
    private static float getApMultipliers(LivingEntity entity, WeaponDamage weaponDamage) {
        ...
        if (weaponDamage == WeaponDamage.FIRE) {
            ...
            if(entity.hasEffect(StatusEffectInit.FLAMESHROUDING_CRACKED.get())) multiplier*=7f;
            ...
            if(entity.hasEffect(StatusEffectInit.HOLYSHROUDING_CRACKED.get())) multiplier*=7f;
        } else if (weaponDamage == WeaponDamage.MAGICAL) {
            if (entity.hasEffect(StatusEffectInit.MAGIC_SCORPION_CHARM.get())) multiplier *= 1.12F;
            if(entity.hasEffect(StatusEffectInit.MAGICSHROUDING_CRACKED.get())) multiplier*=7f;
            ...
            if(entity.hasEffect(StatusEffectInit.LIGHTNINGSHROUDING_CRACKED.get())) multiplier*=7f;
        }
