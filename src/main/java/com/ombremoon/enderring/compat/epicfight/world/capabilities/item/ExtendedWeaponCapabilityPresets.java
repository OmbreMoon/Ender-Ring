...
public class ExtendedWeaponCapabilityPresets {
    ...
    protected static ExtendedWeaponCapability.Builder straightSwordBuilder() {
        return ExtendedWeaponCapability.builder()
                ...
                .styleProvider(playerPatch -> playerPatch.getHoldingItemCapability(InteractionHand.OFF_HAND).getWeaponCategory() == CapabilityItem.WeaponCategories.SWORD || playerPatch.getHoldingItemCapability(InteractionHand.OFF_HAND).getWeaponCategory() == ExtendedWeaponCategories.STRAIGHT_SWORD ? CapabilityItem.Styles.TWO_HAND : CapabilityItem.Styles.ONE_HAND)
                ...
                .heavyMotionValues(CapabilityItem.Styles.ONE_HAND, 1.25F, 1.45F, 1.20F, 1.30F)
